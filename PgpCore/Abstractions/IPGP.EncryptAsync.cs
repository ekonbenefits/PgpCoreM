...
namespace PgpCoreM.Abstractions
{
    public interface IEncryptAsync : IDisposable
    {
        ...
        Task<string> EncryptAsync(string input, bool withIntegrityCheck = true, string name = null, IDictionary<string, string> headers = null, bool oldFormat = false);
        ...
        Task<string> EncryptAndSignAsync(string input, bool withIntegrityCheck = true, string name = null, IDictionary<string, string> headers = null, bool oldFormat = false);
        ...
        Task<string> EncryptArmoredStringAsync(string input, bool withIntegrityCheck = true, string name = null, IDictionary<string, string> headers = null, bool oldFormat = false);
        ...
        Task<string> EncryptArmoredStringAndSignAsync(string input, bool withIntegrityCheck = true, string name = null, IDictionary<string, string> headers = null, bool oldFormat = false);
    }
}