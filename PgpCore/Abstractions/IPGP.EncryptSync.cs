...
namespace PgpCoreM.Abstractions
{
    public interface IEncryptSync : IDisposable
    {
        ...
        string EncryptAndSign(string input, bool withIntegrityCheck = true, string name = null, IDictionary<string, string> headers = null, bool oldFormat = false);
        ...
        string EncryptArmoredStringAndSign(string input, bool withIntegrityCheck = true, string name = null, IDictionary<string, string> headers = null, bool oldFormat = false);
    }
}
